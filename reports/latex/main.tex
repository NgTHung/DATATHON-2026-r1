...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.98\linewidth]{supply.png}
...
Ở cấp danh mục, các nhóm có fill rate cao và stockout thấp có thể được xem là vùng vận hành ổn định, trong khi các nhóm có nhu cầu lớn nhưng fill rate thấp là vùng thất thoát doanh thu cần ưu tiên. Trường hợp Streetwear là ví dụ điển hình: nếu danh mục này có nhu cầu cao nhưng khả năng đáp ứng thấp, thì marketing có thể tạo traffic nhưng doanh thu vẫn không tăng tương ứng vì khách không gặp đúng sản phẩm khi sẵn sàng mua. Ngược lại, các danh mục overstock cần được kiểm soát bằng giảm nhập, bundle, hoặc markdown có mục tiêu để giải phóng vốn.

Vì vậy, hướng hành động cho supply-side là \textbf{chuyển từ quản trị tồn kho theo số lượng sang quản trị tồn kho theo cơ hội doanh thu}. Cụ thể, doanh nghiệp nên ưu tiên bổ sung hàng cho các danh mục có demand cao nhưng fill rate thấp; giảm nhập hoặc xả hàng có kiểm soát ở nhóm overstock; và dùng tín hiệu demand-side như cohort quay lại, traffic, mùa vụ và danh mục ưa thích để cập nhật kế hoạch nhập hàng. Các KPI vận hành cần theo dõi gồm: stockout rate, fill rate, lost revenue proxy, sell-through rate, và tỷ lệ vốn bị khóa ở nhóm overstock.
